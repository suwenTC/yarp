...
def stats(container):
    ...
    #generator = client.containers.stats(id)
    ...
    system_use2=container_stats['cpu_stats']['system_cpu_usage']
    ...
    client.close()
    return {'cpu_percent':cpu_percent,'mem_percent':mem_percent,'network':network_bytes,'id':id}
